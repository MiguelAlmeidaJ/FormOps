...
if (!function_exists('adminSidebarIcon')) {
    function adminSidebarIcon(string $name): string
    {
        $icons = [
            ...
            'checkin' => '<path d="M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Z"/><path d="M14 14h2v2h-2Zm4 0h2v4h-2Zm-4 4h4v2h-4Z"/>',
...
$menuSections = [
    'Principal' => [
        ...
        ['label' => 'Controle de entrada', 'href' => 'ticket-check-in', 'icon' => 'checkin', 'routes' => ['ticket-check-in']],
