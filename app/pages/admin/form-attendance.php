...
<style>
    .attendance-config { background:#fff; border:1px solid #CECECE; border-radius:8px; padding:18px; margin-bottom:18px; box-shadow:0 12px 28px rgba(15,23,42,.05); }
    .attendance-config-title { color:#212121; font-size:15px; font-weight:850; margin:0 0 12px; }
    .attendance-config-grid { display:grid; grid-template-columns:minmax(190px,220px) minmax(0,1fr) auto; gap:14px; align-items:end; }
    .attendance-config .form-label { color:#212121; font-size:13px; font-weight:800; margin-bottom:7px; }
    .attendance-config .form-select { min-height:44px; border-radius:10px; border-color:#CECECE; }
    .attendance-field-wrap { min-width:0; }
    .attendance-field-list { display:flex; flex-wrap:wrap; gap:8px; max-height:96px; overflow:auto; border:1px solid #CECECE; border-radius:10px; padding:10px; background:#F3F3F3; scrollbar-width:thin; }
    .attendance-chip { display:inline-flex; align-items:center; gap:7px; max-width:100%; border:1px solid #CECECE; border-radius:999px; padding:7px 11px; color:#212121; font-size:12px; background:#fff; box-shadow:0 1px 2px rgba(15,23,42,.04); }
    ...
    .attendance-sheet { background:#fff; border:1px solid #CECECE; border-radius:8px; overflow:hidden; }
    .attendance-table th { background:#F3F3F3; color:#555555; font-size:12px; letter-spacing:.04em; text-transform:uppercase; white-space:nowrap; }
    .attendance-table td, .attendance-table th { padding:13px 14px; vertical-align:middle; }
    .signature-line { min-width:170px; height:28px; border-bottom:1px solid #CECECE; }
    .presence-check { width:24px; height:24px; border:2px solid #CECECE; border-radius:6px; display:inline-block; }
