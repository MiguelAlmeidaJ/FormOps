...
<section class="system-settings-grid premium">
    ...
    <article class="system-settings-card full">
        ...
        <div class="system-maintenance-actions">
            ...
            <form method="post" data-confirm="Tem certeza que deseja executar as migrations pendentes? Essa ação pode alterar a estrutura do banco de dados."><input type="hidden" name="maintenance_action" value="migrate_run"><button class="btn btn-primary">Executar migrations pendentes</button></form>
            <form method="post" data-confirm="Tem certeza que deseja limpar o cache da aplicação?"><input type="hidden" name="maintenance_action" value="cache_clear"><button class="btn btn-outline-secondary">Limpar cache</button></form>
