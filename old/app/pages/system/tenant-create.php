...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        try {
            ...
            $stmt->execute([$data['name'],$data['slug'],$data['document']?:null,$data['email']?:null,$data['phone']?:null,$data['logo']?:null,$data['public_title']?:null,$data['public_subtitle']?:null,$data['primary_color']?:'#0d6efd',$data['secondary_color']?:'#198754',$data['background_color']?:'#f6f7fb',$data['text_color']?:'#111827',$data['button_color']?:'#0d6efd',$data['form_style'],isset($_POST['is_active'])?1:0]);
