...
<style>
    .settings-hero{display:flex;justify-content:space-between;gap:20px;margin-bottom:24px}.settings-title{font-size:34px;font-weight:850;letter-spacing:-.04em;color:#0f172a;margin:0}.settings-subtitle{color:#64748b;margin:6px 0 0}.settings-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:20px}.settings-card{background:#fff;border:1px solid #e5e7eb;border-radius:22px;box-shadow:0 18px 40px rgba(15,23,42,.06);padding:22px}.settings-card.full{grid-column:1/-1}.settings-card h2{font-size:18px;font-weight:850;color:#0f172a;margin:0 0 14px}.settings-list{display:grid;gap:12px}.settings-row{display:flex;justify-content:space-between;gap:16px;padding:12px 0;border-top:1px solid #f1f5f9}.settings-row:first-child{border-top:0}.settings-label{color:#64748b;font-size:13px;font-weight:800}.settings-value{color:#0f172a;font-weight:800;text-align:right}.maintenance-actions{display:flex;flex-wrap:wrap;gap:10px;margin:16px 0}.maintenance-actions .btn{border-radius:12px;font-weight:800}.settings-output{white-space:pre-wrap;background:#0f172a;color:#dbeafe;border-radius:16px;padding:16px;max-height:320px;overflow:auto;font-size:13px}.maintenance-status{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin:14px 0}.maintenance-pill{border:1px solid #e5e7eb;border-radius:16px;padding:14px;background:#f8fafc}.maintenance-pill span{display:block;color:#64748b;font-size:12px;font-weight:800;text-transform:uppercase}.maintenance-pill strong{display:block;margin-top:4px;color:#0f172a}.log-table{width:100%;border-collapse:collapse}.log-table th,.log-table td{padding:12px;border-top:1px solid #f1f5f9;font-size:14px}.log-table th{color:#64748b;text-transform:uppercase;font-size:11px;letter-spacing:.08em}.status-ok{color:#16a34a;font-weight:800}.status-error{color:#dc2626;font-weight:800}@media(max-width:991px){.settings-grid,.maintenance-status{grid-template-columns:1fr}.settings-hero{display:block}.settings-value{text-align:left}.settings-row{display:block}}
</style>
    ...
    <?php if (isSuperAdmin()): ?>
        <article class="settings-card full">
            ...
            <div class="maintenance-actions">
                ...
                <form method="post" onsubmit="return confirm('Tem certeza que deseja executar as migrations pendentes? Essa ação pode alterar a estrutura do banco de dados.');"><input type="hidden" name="maintenance_action" value="migrate_run"><button class="btn btn-primary">Executar migrations</button></form>
