...
ALTER TABLE tenants ADD COLUMN background_color VARCHAR(20) DEFAULT '#f6f7fb';
ALTER TABLE tenants ADD COLUMN text_color VARCHAR(20) DEFAULT '#111827';
ALTER TABLE tenants ADD COLUMN button_color VARCHAR(20) DEFAULT '#0d6efd';
